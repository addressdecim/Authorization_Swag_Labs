...
def authorization_test_6(browser):
    print("authorization_test_6 start")
    browser.refresh()
    ...
    print("Username: Input password")
    rtrn.get_path_wait(browser, locator.password).send_keys(data_text.login_standard_user)
    ...
    print("Error remove")
    print("authorization_test_6 end \n")
